...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageView imageGo = (ImageView) findViewById(R.id.imageGo);
        Animation b = AnimationUtils.loadAnimation(this, R.anim.two);

        imageGo.startAnimation(b);


/*
        Animation anim = new AlphaAnimation(0.0f, 1.0f);
    anim.setDuration(550); //You can manage the time
...
*/
    ...
    public void startInterpolator(View v ){
